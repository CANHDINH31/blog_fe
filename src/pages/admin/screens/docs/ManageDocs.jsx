    ...
    >
      {postsData?.data.map((post) => (
        <tr>
          ...
          <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
            {post.isPublic ? (
              <p className="text-green-600 hover:text-green-900  disabled:cursor-not-allowed disabled:opacity-70">
                true
              </p>
            ) : (
              <p className="text-red-600 hover:text-red-900 disabled:cursor-not-allowed disabled:opacity-70">
                false
              </p>
            )}
          </td>
